...
TEMPLATES_PATH = "pyfecons.costing.mfe.templates.lite"
INCLUDED_FILES_PATH = "pyfecons.costing.mfe.included_files.lite"
DOCUMENT_TEMPLATE = "Costing_ARPA-E_MFE_Lite.tex"
...
def CreateReportContentLite(
    ...
    for section in report_sections:
        if section.template_file == "powerTableMFEDT.tex":
            section.template_file = "powerTableMFEDT.tex"
    ...
    parent_included_files_path = "pyfecons.costing.mfe.included_files"
    ...
    included_files["Figures/MFE.png"] = get_included_file_path(
        parent_included_files_path, "Figures/MFE.png", overrides
    )
