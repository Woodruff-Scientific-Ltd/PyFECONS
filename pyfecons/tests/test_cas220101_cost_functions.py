...
from pyfecons.enums import ReactorType, ConfinementType, BlanketFirstWall, BlanketType, BlanketPrimaryCoolant, \
    BlanketSecondaryCoolant, BlanketNeutronMultiplier, BlanketStructure
from pyfecons.inputs import Blanket, RadialBuild
from pyfecons.units import Ratio, Meters


class TestCAS220101TotalCost(unittest.TestCase):

    def test_mfe_tokamak(self):
        blanket = Blanket(
