...
def cas_50(inputs: Inputs, data: Data) -> TemplateProvider:
    ...
    if inputs.basic.noak:
        ...
        OUT.C590000 = M_USD(0.1 * (OUT.C580000 + OUT.C550000 + OUT.C540000
                                   + OUT.C530000 + OUT.C520000 + OUT.C510000))

    OUT.C500000 = M_USD(OUT.C510000 + OUT.C520000 + OUT.C530000 + OUT.C540000
                        + OUT.C550000 + OUT.C580000 + OUT.C590000)
