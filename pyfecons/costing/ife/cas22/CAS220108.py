...
def cas_220108_target_factory(inputs: Inputs, data: Data) -> TemplateProvider:
    ...
    OUT.C220108 = M_USD(target_factory_costs['Total process'].tcc_dollars.scaled_cost/1e6)
    ...
    OUT.replacements = {
        ...
        'facilityManagementCosts': target_factory_costs['Facility management costs'].cost_row,
