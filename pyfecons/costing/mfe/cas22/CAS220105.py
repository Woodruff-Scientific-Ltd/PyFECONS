from pyfecons.costing.calculations.cas22.cas220105_primary_structure import compute_engineering_costs, \
...
def cas_220105_primary_structure(inputs: Inputs, data: Data) -> TemplateProvider:
    ...
    OUT.C22010501 = compute_engineering_costs(inputs.primary_structure, data.power_table)
    OUT.C22010502 = compute_fabrication_costs(inputs.primary_structure, data.power_table)
