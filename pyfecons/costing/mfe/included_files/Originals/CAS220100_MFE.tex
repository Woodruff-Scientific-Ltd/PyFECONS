...
\begin{itemize}
    ...
    \item Cost Category 22.01.20 Disruption Mitigation System. This includes the shattered pellet injection system used to mitigate plasma disruption effects in tokamak fusion reactors, ensuring safe operation during plasma instabilities.
 \end{itemize}
