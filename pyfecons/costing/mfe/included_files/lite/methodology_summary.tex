...
\begin{itemize}
    \item \textbf{Woodruff's "A Costing Framework for Fusion Power Plants"} \cite{Woodruff2026CostingFrameworkFusion}: Comprehensive framework for fusion power plant cost estimation
