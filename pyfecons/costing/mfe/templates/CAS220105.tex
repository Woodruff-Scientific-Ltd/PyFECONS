% copied from https://github.com/Woodruff-Scientific-Ltd/PyFECONS/blob/884a3f842f0e5027e0c8e20591624d6251cc399f/MFE/Originals/CAS220105.tex#L1
...
The cost of this category has been largely based on a survey of the structural costs of nuclear fission conducted by Lal et al.
% \cite{lal2022towards}. % TODO - implement citation
Costs associated with this system can be broken into the following.
\begin{itemize}
...
It has been shown
% \cite{lal2022towards} % TODO - implement citation
that the costs for this category are significantly impacted by the seismic load, and decreasing the PGA at the reactor, greatly reduces costs. One means for isolation is to mount the reactor on numerous concave Friction Pendulum (FP) bearings. By employing these FP bearings, a cost saving of 40-50\% can be achieved.
% \cite{lal2022towards}. % TODO - implement citation
