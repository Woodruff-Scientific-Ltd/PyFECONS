% copied from https://github.com/Woodruff-Scientific-Ltd/PyFECONS/blob/884a3f842f0e5027e0c8e20591624d6251cc399f/MFE/Originals/CAS100000.tex#L1
...
\ifsafetycosts
Accounting for tritium release from storage, the total land and land rights cost C110000 is conceptually split into:
\begin{itemize}
  \item C110100: baseline site land cost based on neutron and fusion power (as above), and
  \item C110200: additional safety-driven land and mitigation cost associated with tritium release from storage.
\end{itemize}
In this case C110000 = C110100 + C110200.
\fi
...
\ifsafetycosts
Accounting for region-specific licensing requirements, an additional region-dependent licensing cost is included in the total above. This addon accounts for regulatory fees and licensing requirements specific to the selected region (United States or United Kingdom). For the United States, this includes NRC licensing fees for byproduct materials facilities. For the United Kingdom, this includes fees under REPPIR 2019 and Environment Agency charges. The total cost shown above (\$ C130000 M) already incorporates this region-specific licensing addon.
\fi
