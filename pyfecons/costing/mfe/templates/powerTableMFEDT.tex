...
1.5	&	Pumping power capture efficiency	&	$\eta_{{pump}}$	&	00ETAP	&	\\
...
2.1.1	&	Power into TF coils	&	$P_{{tf}}$	&	000PTF	&	MW \\
2.1.2	&	Power into PF (equilibrium) coils	&	$P_{{pf}_e}$	&	000PPF		&	MW \\
