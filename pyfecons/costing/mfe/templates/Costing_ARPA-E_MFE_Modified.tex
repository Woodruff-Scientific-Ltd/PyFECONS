...
\usepackage{hyperref}
\usepackage{etoolbox}
\usepackage{comment} % TODO - add to templates repo
...
%\pagestyle{fancy}
    ...
    \input{Modified/CAS220103_MFE_DT_tokamak.tex} % TODO - change name in templates repo
...
\fi
    ...
    %\input{Modified/NPV.tex}  # TODO: Fix NPV calc and implement
