...
def compute_220101_replacements(reactor_type: ReactorType, blanket: Blanket,
    ...
    return {
        ...
        **({'TH11': round(IN.coil_t, rounding)} if reactor_type == ReactorType.MFE else {}),
        ...
        **({'RAD11I': round(OUT.coil_ir, rounding)} if reactor_type == ReactorType.MFE else {}),
        ...
        **({'RAD11O': round(OUT.coil_or, rounding)} if reactor_type == ReactorType.MFE else {}),
        ...
        **({'VOL11': round(OUT.coil_vol, rounding)} if reactor_type == ReactorType.MFE else {}),
