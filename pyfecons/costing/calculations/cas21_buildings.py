...
def cas_21_building_costs(inputs: AllInputs, data: Data) -> TemplateProvider:
    ...
    OUT.replacements = {
        "C210000": str(round(OUT.C210000, 1)),
        "C210100": str(round(OUT.C210100, 1)),
        "C210200": str(round(OUT.C210200, 1)),
        "C210300": str(round(OUT.C210300, 1)),
        "C210400": str(round(OUT.C210400, 1)),
        "C210500": str(round(OUT.C210500, 1)),
        "C210600": str(round(OUT.C210600, 1)),
        "C210700": str(round(OUT.C210700, 1)),
        "C210800": str(round(OUT.C210800, 1)),
        "C210900": str(round(OUT.C210900, 1)),
        "C211000": str(round(OUT.C211000, 1)),
        "C211100": str(round(OUT.C211100, 1)),
        "C211200": str(round(OUT.C211200, 1)),
        "C211300": str(round(OUT.C211300, 1)),
        "C211400": str(round(OUT.C211400, 1)),
        "C211500": str(round(OUT.C211500, 1)),
        "C211600": str(round(OUT.C211600, 1)),
        "C211700": str(round(OUT.C211700, 1)),
        "C211900": str(round(OUT.C211900, 1)),  # TODO - not in the template file
    }
    return OUT
