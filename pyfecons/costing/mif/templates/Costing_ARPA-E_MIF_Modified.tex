...
\makeatother
%\pagestyle{fancy}
\title{MIF Concept\\ Proprietary Report} 
...
\begin{figure}[h!] 
\centering 
\includegraphics[scale=0.7]{{Figures/FrontMatter.eps}} 
\caption{MIF Fusion Energy System} 
\label{fig:render} 
\end{figure} 
\newpage 
\textbf{Foreword} \\ 
...
\input{Originals/powerBalanceMIFDT.tex}
%\input{Modified/powerTableMIFDT.tex}
%\input{Modified/CAS100000.tex}
%\input{Modified/CAS200000.tex}
%\input{Modified/CAS210000.tex}
%\input{Modified/CAS220000.tex}
\input{Originals/CAS220100_MIF.tex}
%\input{Modified/CAS220101_MIF_DT.tex}
%\input{Modified/CAS220102.tex}
%\input{Modified/CAS220103_MIF_DT_mirror.tex}
%\input{Modified/CAS220104_MIF_DT.tex}
%\input{Modified/CAS220105.tex}
%\input{Modified/CAS220106_MIF.tex}
%\input{Modified/CAS220107_MIF.tex}
%\input{Modified/CAS220108_MIF.tex}
