"""
Safety-specific DefineInputs for CATF IFE.

This module reuses the baseline CATF IFE DefineInputs.Generate() and only
...
from customers.CATF.ife.DefineInputs import Generate as _GenerateBase


def Generate():
    """
    Return an AllInputs instance identical to the baseline CATF IFE
